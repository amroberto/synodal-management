<div class="relative mb-6 w-full">
    <div class="mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item>Cargos</flux:breadcrumbs.item>
        </flux:breadcrumbs>
    </div>
    
    <flux:heading size="xl" level="1">{{ __('Listagem de Cargos') }}</flux:heading>
    ...
    <flux:modal.trigger name="create-position">
        <flux:button variant="primary" icon="plus-circle">{{ __('Criar Cargo') }}</flux:button>
    </flux:modal.trigger>
    ...
    <flux:modal name="delete-position" class="min-w-[22rem]">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Deseja realmente apagar este cargo?</flux:heading>

                <flux:text class="mt-2">
                    Você está prestes a excluir este cargo.<br>
            ...
            <div class="flex gap-2">
                ...
                <flux:button type="submit" variant="danger" wire:click="deletePosition()">Apagar Cargo</flux:button>
            </div>
        </div>
    </flux:modal>
</div>